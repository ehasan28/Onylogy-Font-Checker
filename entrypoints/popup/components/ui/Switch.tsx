...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    {...props}
  >
    <SwitchPrimitive.Thumb className="pointer-events-none block h-3.5 w-3.5 translate-x-0.5 rounded-full bg-fg-muted shadow-pop transition-transform data-[state=checked]:translate-x-[18px] data-[state=checked]:bg-accent-contrast" />
  </SwitchPrimitive.Root>
));
